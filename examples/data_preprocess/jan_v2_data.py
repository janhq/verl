...
def process_single_row(row, row_index):
    ...
    # Process data source
    data_source_tagged = "janv2_searchqa"
...
def main():
    ...
    ds = load_dataset(args.hf_repo_id, split="train")
    ...
    output_file_path = os.path.join(local_save_dir, f"train.parquet")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--hf_repo_id", default="Menlo/musique_subset_aggregate", help="HuggingFace dataset repository ID."
    )
    parser.add_argument(
        "--local_dir",
        default="./data/janv2_searchqa",
